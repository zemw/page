...
\[\begin{aligned}
\Delta y_t = & \beta_1\Delta s_{t-1} + & \beta_2 r_{t-1}^{SP} + & \mathbf{\gamma' x_{t-1}}\\
             &-2.061^{**}              &0.029 & \\
\end{aligned}\]
...
\[\begin{aligned}
\Delta\hat s_t = & \theta_1 s_{t-2} + & \theta_2\ln\text{HYS}_{t-2} & \\
                 & 0.095^{***}        & -0.248^{***}  &  \\
\hat r^{SP}_t = & \theta_3 \ln(P/E10)_{t-2}  & \\
                & -0.134^{***} &  \\
\end{aligned}\tag{1}\]

\[\begin{aligned}
\Delta y_{t+h} = & \beta_1\Delta\hat s_{t-1} + & \beta_2\hat r_{t-1}^{SP} + 
                 & \mathbf{\gamma' x_{t-1}} &  \\
                 & -4.800^{***} & 0.069 & \\
\end{aligned}\tag{2}\]
